 ...
 */
// Ohne sichtbares Ernährungsmodul bekommt das Modell die Ernährungs-Werkzeuge
// gar nicht erst angeboten – was es nicht kennt, kann es nicht aufrufen.
const NUTRI_TOOLS = ['log_food', 'add_water', 'nutrition_today'];
function activeTools() {
  if (require('./features').ernOn()) return ACTION_TOOLS;
  return ACTION_TOOLS.filter(function (t) { return NUTRI_TOOLS.indexOf(t.name) < 0; });
}
