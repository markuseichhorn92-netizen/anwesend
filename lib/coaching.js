...
function fullLesson(track, week) {
  const arr = lessonsFor(track);
  const l = arr[clampInt(week, 1, arr.length, 1) - 1];
  return { week: l.week, title: l.title, theme: l.theme, teaser: l.teaser, minutes: l.minutes, season: l.season || 'Kern', pages: normPages(l.pages), quiz: normQuiz(l.quiz), exercise: l.exercise, habits: l.habits };
}
