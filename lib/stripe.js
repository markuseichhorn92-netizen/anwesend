...
// SetupIntent für den Karten-Wechsel (Payment Element).
async function createSetupIntent(customerId) {
  if (!customerId) return { ok: false, error: 'no_customer' };
  const r = await stripe('POST', '/setup_intents', { customer: customerId, usage: 'off_session', payment_method_types: ['card'] });
...
module.exports = {
  ...
  getSubscription, cancelSubscription, createSetupIntent, setDefaultPaymentMethod, listInvoices,
