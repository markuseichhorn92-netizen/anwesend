...
async function kassenbuchCheck(ctx) {
  ...
  const system = [
    ...
    'Sei kurz und konkret. Höchstens 8 Befunde – nur dort, wo wirklich etwas zu verbessern oder zu berücksichtigen ist, getrennt pro Spalte/Thema. Prüfe u. a.: Rechenkontrolle (Anfang + Einnahmen − Ausgaben = Endbestand); negativer Barbestand (bar unmöglich); Kassendifferenz beim Kassensturz; fehlende Beschreibung/Belegzweck bei Ausgaben oder Sonstiges; Privateinlagen/-entnahmen sauber kennzeichnen; auffällig runde/immer gleiche Beträge; GoBD (zeitnah, unveränderbar, kassensturzfähig, vollständig); Belegpflicht & 10 Jahre Aufbewahrung; Umsatzsteuer-Bezug (7 % Speisen/Getränke vor Ort vs. 19 % „to go"/Waren, Kleinunternehmer beachten).',
