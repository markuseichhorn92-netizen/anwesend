...
async function scanInbody(base64, mediaType) {
  ...
  const sys = [
    ...
    '{"date":"YYYY-MM-DD","weight":0,"height":0,"age":0,"sex":"w","tbw":0,"protein":0,"mineral":0,"bfm":0,"smm":0,"ffm":0,"pbf":0,"bmi":0,"whr":0,"vfl":0,"bmr":0,"score":0,"targetWeight":0,"recommendedKcal":0}',
  ].join('\n');
  const content = [
    { type: 'text', text: 'Lies alle Messwerte dieses InBody-Bogens aus.' },
    { type: 'image', source: { type: 'base64', media_type: mt, data: data } },
  ];
