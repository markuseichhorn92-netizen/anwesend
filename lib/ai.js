...
async function nutritionRecipes(ctx) {
  ...
  const sys = [
    ...
    '{"recipes":[{"title":"Name","servings":2,"minutes":20,"kcal":0,"protein":0,"carbs":0,"fat":0,"weightG":0,"fruitVegPct":0,"ingredients":[{"name":"Reis","grams":60}],"steps":["Schritt …"],"finnRating":{"stars":4,"text":"Kurzbegründung"}}]}',
