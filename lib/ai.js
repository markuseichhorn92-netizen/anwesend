...
async function nutritionRecipes(ctx) {
  ctx = ctx || {};
  if (!hasAI) return { ok: false, error: 'no_ai_key' };
  const count = Math.max(1, Math.min(5, parseInt(ctx.count, 10) || 3));
  ...
  const sys = [
    ...
    '{"recipes":[{"title":"Name","servings":2,"minutes":20,"kcal":0,"protein":0,"carbs":0,"fat":0,"weightG":0,"fruitVegPct":0,"utensils":["Pfanne","Schüssel"],"ingredients":[{"name":"Reis","grams":60}],"steps":["Schritt …"],"finnRating":{"stars":4,"text":"Kurzbegründung"}}]}',
