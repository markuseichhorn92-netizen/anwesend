...
async function scanAttest(base64, mediaType, opts) {
  ...
  const sys = [
    ...
    'Antworte AUSSCHLIESSLICH mit JSON, ohne Text drumherum, in genau dieser Form:',
    '{"found":true,"untilDate":"YYYY-MM-DD","startDate":"YYYY-MM-DD","kind":"krankheit","confidence":"high","note":"kurze Begründung, welche Zeile das Datum liefert"}',
...
module.exports = { askHelp, coachReply, coachTip, draftReply, estimateFood, estimateFoodPhoto, scanAttest, nutritionRecipes, nutritionReply, nutritionWeekPlan, nutritionWeekReview, messagesRaw, winbackSuggest, winbackMessage, hasAI, MODEL };
