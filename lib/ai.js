...
async function estimateFood(text) {
  ...
  const sys = [
    ...
    'p=Eiweiß in g, c=Kohlenhydrate in g, f=Fett in g. Alle Zahlen als ganze Zahlen. Höchstens 8 Einträge.',
    'Beschreibt die Eingabe kein Essen/Trinken, gib {"items":[]} zurück. Keine Erklärungen.',
  ].join('\n');
...
module.exports = { askHelp, coachReply, coachTip, draftReply, estimateFood, nutritionRecipes, nutritionReply, hasAI, MODEL };
