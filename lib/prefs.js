...
//   pushCoach     Ernährungs-Coaching: Tagesimpuls von FINN
//   pushSocial    Trainingspartner: neue Nachricht/Anfrage
const BOOL_KEYS = ['reminders', 'push', 'pushPostfach', 'pushTermin', 'pushKonto', 'pushNews', 'pushCoach', 'pushSocial'];
