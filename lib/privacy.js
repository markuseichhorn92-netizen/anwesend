...
const DEFINITIONS = Object.freeze({
  ...
  lifestyle_health: {
    ...
    // Seit September 2026 gibt es kein „Vitalalter“ mehr; die Selbstauskunft ist aus
    // der App genommen. Bereits erteilte Einwilligungen bleiben nachweisbar, gespeicherte
    // Angaben fließen nur noch in FINNs Kontext – bis zum Widerruf oder zur Löschung.
    purpose: 'Persönliche Wellness-Hinweise',
    categories: ['Schlaf', 'Stress', 'Sitzen', 'Rauchen'],
    recipients: ['Fit-Inn Trier', 'Vercel', 'Amazon Web Services (nur bei FINN-Auswertung)'],
    text: 'Ich willige ausdrücklich ein, dass Fit-Inn Trier meine freiwilligen Lebensstil-Angaben für persönliche Wellness-Hinweise verarbeitet. Die Einwilligung ist freiwillig und jederzeit widerrufbar.',
  },
