...
// Gültig, wenn lang genug UND entweder Puls ODER (outdoor) eine Strecke vorliegt.
function validSession(s) { return !!(s && s.durationSec >= 10 && (s.avgHr > 0 || (s.kind === 'outdoor' && s.distanceM > 0))); }
