...
// Client-sichere Kontingent-Anzeige. `used` = tatsächlich genutzte KI-Aktionen im Monat
// (auch für Premium sichtbar, für die Nutzungsübersicht). `remaining`/Limit nur für Basic.
