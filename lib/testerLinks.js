...
// iOS ist bereits im App Store veröffentlicht (kein Test-Beitritt nötig) – direkter Store-Link.
const IOS_URL = String(process.env.IOS_TEST_URL || 'https://apps.apple.com/de/app/fit-inn-trier/id6785785628').trim();
