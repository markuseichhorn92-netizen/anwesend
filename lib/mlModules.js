...
async function bookModule(contractId, moduleId, paymentFrequencyId) {
  ...
  if (r && r.status >= 200 && r.status < 300) {
    var newId = r.json && (r.json.id != null ? r.json.id
      : (r.json.additionalModuleContractId != null ? r.json.additionalModuleContractId : null));
...
module.exports = {
  ...
  PREMIUM_MODULE_ID, premiumConfigured, isPremiumModule,
};
